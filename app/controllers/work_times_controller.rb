class WorkTimesController < ApplicationController
  ...
  def datatable
    render json: WorkTimesDatatable.new(params, view_context: view_context)
  end
  ...
  private
    ...
    def work_time_params
      params.require(:work_time).permit(:allocation_id, :work_date, :hours, :minutes, :computed_hours, :status)
    end
end
