...
class <%= controller_class_name %>Controller < ApplicationController
  ...
  private
    ...
    def <%= "#{singular_table_name}_params" %>
      <%- attributes_names = attributes.empty? && Object.const_defined?(singular_table_name.classify) ? singular_table_name.classify.constantize.column_names - ['id', 'created_at', 'updated_at'] : attributes.map(&:name) -%>
